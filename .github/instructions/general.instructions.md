...
We generally use the GitHub CLI extension [gh-tt](https://github.com/devx-cafeechcollective/gh-tt) to manage our issues and branches. Most impotantly it supports `workon`, `wrapup` and `deliver`.
